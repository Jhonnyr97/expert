...
class global_navigation extends navigation_node {
    ...
    public function initialise() {
        ...
        if (get_home_page() == HOMEPAGE_SITE) {
             ...
             * when detect the user is editingteacher the navigation link of my home dosen´t appear,
             * when it is other type of user, the navigation link of my home appear
             */
    ...
    public function add_front_page_course_essentials(navigation_node $coursenode, stdClass $course) {
        ...
        /**
         * Moodle_Custom_Design
         * Add filter !isteacheruser() to not show Calendar in the navigation menu
         */
        if ($navoptions->calendar && !isteacheruser()) {
            $courseid = $COURSE->id;
