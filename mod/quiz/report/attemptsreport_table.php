...
//seleziona il gruppo di negozi dell'utente loggato se non è amministratore, e quindi è un manager
$gruppoNegozi ='';
...
abstract class quiz_attempts_report_table extends table_sql {
    ...
    public function __construct($uniqueid, $quiz, $context, $qmsubselect,
        ...
        //seleziona solo gli utenti con gruppo di negozi uguale a quello del manager loggato, se è admin non filtra il department
        global $gruppoNegozi;
        if($gruppoNegozi!=''){
            $this->studentsjoins->wheres .= " AND u.department='".$gruppoNegozi."' ";
        }
