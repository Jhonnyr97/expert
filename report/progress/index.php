...
//$codiceGruppoNegozi= $USER->department; c5
...
$sitecontext = context_system::instance(); //c1
...
foreach($progress as $user) {
    //se chi è loggato non è un site admin mostra solo gli utenti appartenenti al gruppo negozi del manager loggato
    /*if($user->department ==  $codiceGruppoNegozi || is_siteadmin($USER))
    { c3*/
        // User name
        if ($csv) {
